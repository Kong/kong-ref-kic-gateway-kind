...
helm install --version 2.20.2 -f ./helm-values/cp-values.yaml kong kong/kong -n kong \
...
helm install --version 2.20.2 -f ./helm-values/dp-values.yaml kong-dp kong/kong -n kong-dp \
